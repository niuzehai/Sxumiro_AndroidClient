...
//        setContentView(R.layout.activity_todo_add_to_do);
...
//        setDateAndTimeEditText();
    ...
    public void setReminderTextView(){
        if(mUserReminderDate!=null){
            ...
            String dateString = formatDate("yyyy ,d MMM", date);
            String timeString;
            String amPmString = "";
            ...
            String finalString = String.format(getResources().getString(R.string.remind_date_and_time), timeString, dateString, amPmString);
