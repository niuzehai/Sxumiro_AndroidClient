package com.do79.SxuMiro.utils.logger;
...
/**
 * Logger is mFragmentStatePagerAdapter wrapper of {@link android.util.Log}
...
public final class Logger {
    ...
    /**
     * Android's max limit for mFragmentStatePagerAdapter log entry is ~4076 bytes,
    ...
    /**
     * TAG is used for the Log, the name is mFragmentStatePagerAdapter little different
    ...
    private synchronized static void log(int logType, String tag, String message, int methodCount) {
        ...
        for (int i = 0; i < length; i += CHUNK_SIZE) {
            ...
            //create mFragmentStatePagerAdapter new String with system's default charset (which is UTF-8 for Android)
